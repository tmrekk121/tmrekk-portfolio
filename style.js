...
function fetchHTML(e) {
    ...
    xmlhr.onreadystatechange = function() {
        if (xmlhr.readyState == 4 && xmlhr.status==200) {
            ...
            document.getElementById("slide").setAttribute("style", "width: 0; height: 0; animation: fadeOut 4s ease 0s 1 normal;\
...
function transTop() {
  document.getElementById("item-content").setAttribute("style", "width: 0; height: 0; animation: fadeOut 4s ease 0s 1 normal;\
  -webkit-animation: fadeOut 4s ease 0s 1 normal;");
